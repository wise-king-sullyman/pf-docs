...
module.exports = (_env, argv) => {
  ...
  return {
    entry: path.resolve(_PF_DOCS_PACKAGE_PWD, './app/app.js'),
    output: {
    ...
    resolve: {
      ...
      alias: {
        'client-styles': path.resolve(_PF_DOCS_PACKAGE_PWD, 'webpack/app/global.css.js'),
    ...
    plugins: [
      ...
      new CopyWebpackPlugin({
        patterns: [
          { from: path.join(_PF_DOCS_PACKAGE_PWD, 'src/webpack/app/assets'), to: 'assets' }
        ]
      }),
