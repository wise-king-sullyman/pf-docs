...
import { copy, trackEvent } from '../../helpers';
/**
 * Return language used for example.
 *
 * @param {string} lang
 * @returns {Language.typescript|Language.javascript|*}
 */
 ...
 *
 * @param {object} props
 * @param {string} props.fullscreenLink
 * @param {*} props.codeBoxParams
 * @param {string} props.lang
 * @param {boolean} props.isFullscreen
 * @param {*} props.originalCode
 * @param {*} props.code
 * @param {Function} props.setCode
 * @param {Function} props.convertToJSX
...
export const ExampleToolbar = ({
  ...
  setCode,
  convertToJSX: aliasedConvertToJSX = convertToJSX
}) => {
    ...
    <React.Fragment>
      ...
      {isEditorOpen && lang === 'ts' && (
        <CodeEditorControl
          ...
          onClick={() => {
            setCode(aliasedConvertToJSX(code).code);
