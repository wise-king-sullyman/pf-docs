...
import { Brand, Grid, GridItem, List, PageSection } from '@patternfly/react-core';
import { GithubIcon, TwitterIcon } from '@patternfly/react-icons';
import { Link } from '../link/link';
import redhatLogo from '../../assets/images/RHLogo.png';
        ...
        <GridItem sm={12} md={6} mdOffset={1} className="pf-u-mb-lg pf-u-mb-0-on-sm">
          <Grid className="pf-u-py-xl">
            <GridItem sm={6} md={4} className="pf-u-ml-md pf-u-ml-0-on-md pf-u-mb-xl pf-u-mb-0-on-md">
              <p className="pf-c-title ws-org-pfsite-footer-menu-list-title">QUICKLINKS</p>
            ...
            >
              <p className="pf-c-title ws-org-pfsite-footer-menu-list-title">CONTRIBUTE</p>
            ...
            <GridItem sm={6} md={4} className="pf-u-mt-lg pf-u-mt-0-on-md pf-u-ml-md pf-u-ml-0-on-md">
              <p className="ws-org-pfsite-footer-menu-list-title">STAY IN TOUCH</p>
          ...
          <Grid className="pf-u-pt-xl ws-org-pfsite-l-footer-column">
            <GridItem className="pf-u-px-xl">
              ...
              <p className="ws-org-pfsite-footer-menu-about-description">
                PatternFly is an open source design system built to drive consistency and unify teams. From
                documentation and components to code examples and tutorials, PatternFly is a place where design and
                development can thrive. We’re on a mission to help teams build consistent, accessible, and scalable
                enterprise product experiences—the open source way.
              </p>
            </GridItem>
            <GridItem className="ws-org-pfsite-footer-menu-social-links pf-u-px-xl">
              <Link to="//github.com/patternfly" target="top" aria-label="Link to PatternFly GitHub page">
                <GithubIcon />
              </Link>
              <Link to="//twitter.com/patternfly" target="top" aria-label="Link to PatternFly Twitter page">
                <TwitterIcon />
              </Link>
            </GridItem>
          </Grid>
    ...
    <PageSection key="footer-2" className="ws-org-pfsite-l-footer-dark pf-m-no-fill">
      <Grid className="pf-u-py-xl-on-sm pf-u-py-0-on-md pf-u-align-items-center">
        <GridItem md={2} mdOffset={1}>
          <Link to="//www.redhat.com" target="top" aria-label="Visit Red Hat.com">
            <img src={redhatLogo} alt="Red Hat logo" width="145px" height="613px" />
          </Link>
        </GridItem>
        <GridItem md={4} lg={3} xl={2}>
          <span className="ws-org-pfsite-site-copyright">Copyright &copy; 2021 Red Hat, Inc.</span>
        </GridItem>
        <GridItem md={4} lg={5} className="pf-u-ml-xl-on-xl">
          <Link to="//www.redhat.com/en/about/privacy-policy" target="top" aria-label="Privacy statement">
            Privacy statement
          </Link>
          <Link to="//www.redhat.com/en/about/terms-use" target="top" aria-label="Terms of use">
            Terms of use
          </Link>
          <Link
